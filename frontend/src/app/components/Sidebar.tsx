...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-54 transition-opacity duration-200 ease-in-out ${
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-64 bg-zinc-900 border-r border-zinc-800 z-60 p-4 transform transition-transform duration-200 ease-in-out ${
